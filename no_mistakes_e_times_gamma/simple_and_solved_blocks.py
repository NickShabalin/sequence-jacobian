...
production = solved(block_list=[output_aggregation, production_sec, investment,
                                wage_labor_aggregates, pricing,
                                pricing_intermediate],
                    unknowns=['Q_sec_1', 'Q_sec_2', 'Q_sec_3', 'K_sec_1', 'K_sec_2', 'K_sec_3',
                              'Y_sec_1', 'Y_sec_2', 'Y_sec_3',
                              'N_occ_sec_1_1', 'N_occ_sec_1_2', 'N_occ_sec_1_3',
                              'N_occ_sec_2_1', 'N_occ_sec_2_2', 'N_occ_sec_2_3',
                              'N_occ_sec_3_1', 'N_occ_sec_3_2', 'N_occ_sec_3_3',
                              'mc_sec_1', 'mc_sec_2', 'mc_sec_3'],
                    targets=['inv_sec_1', 'inv_sec_2', 'inv_sec_3', 'val_sec_1', 'val_sec_2', 'val_sec_3',
                             'prod_sec_1', 'prod_sec_2', 'prod_sec_3',
...
def occupation_choice(N_occ, gamma_hh_1, gamma_hh_2, gamma_hh_3, m1, m2, m3, tax, frisch, vphi_1, vphi_2, vphi_3, w_occ, possible_occupation, p, infected, susceptible, recovered, beta_sir, occupation_mult_for_covid):
    ...
    u_c_number_1 = covid_mult_1 * vphi_1 * N_raw_1 ** (1 / frisch) / (1 - tax) / w_occ / gamma_hh_1 * p
    u_c_number_2 = covid_mult_2 * vphi_2 * N_raw_2 ** (1 / frisch) / (1 - tax) / w_occ / gamma_hh_2 * p
    u_c_number_3 = covid_mult_3 * vphi_3 * N_raw_3 ** (1 / frisch) / (1 - tax) / w_occ / gamma_hh_3 * p
    u_c_1_1 = u_c_number_1_1
    u_c_1_2 = u_c_number_1_2
    u_c_1_3 = u_c_number_1_3
    u_c_2_1 = u_c_number_2_1
    u_c_2_2 = u_c_number_2_2
    u_c_2_3 = u_c_number_2_3
    u_c_3_1 = u_c_number_3_1
    u_c_3_2 = u_c_number_3_2
    u_c_3_3 = u_c_number_3_3
    u_c_1 = [u_c_1_1, u_c_1_2, u_c_1_3]
    u_c_2 = [u_c_2_1, u_c_2_2, u_c_2_3]
    u_c_3 = [u_c_3_1, u_c_3_2, u_c_3_3]
    occupation_1 = u_c_1.index(min(u_c_1))
    occupation_2 = u_c_2.index(min(u_c_2))
    occupation_3 = u_c_3.index(min(u_c_3))
    ...
    return N_hh_occ_1, N_hh_occ_2, N_hh_occ_3, occupation_1, occupation_2, occupation_3, u_c_number_1, u_c_number_2, u_c_number_3


@simple
def sir_block(susceptible, infected, recovered, covid_shock, beta_sir, gamma_sir, C, N):
    sus_eq = susceptible - (1 - beta_sir * infected(-1) * C * N ** 2 / (infected(-1) + recovered(-1) + susceptible(-1))
                            ) * susceptible(-1) + covid_shock

    inf_eq = infected - (1 - gamma_sir + beta_sir * susceptible(-1) * C * N ** 2 / (infected(-1) + recovered(-1) + susceptible(-1))
