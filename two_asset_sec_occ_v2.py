...
def income1(e_grid, tax, w1, w2, w3, gamma, m, N):
    ...
    return z_grid, N_hh_occ_1_1, N_hh_occ_1_2, N_hh_occ_1_3


def income2(e_grid, tax, w1, w2, w3, gamma, m, N):
    ...
    return z_grid, N_hh_occ_2_1, N_hh_occ_2_2, N_hh_occ_2_3

def income3(e_grid, tax, w1, w2, w3, gamma, m, N):
    ...
    return z_grid, N_hh_occ_3_1, N_hh_occ_3_2, N_hh_occ_3_3



# comment: two different types of hh instead of one
household_inc1 = household1.attach_hetinput(income1)
household_inc2 = household2.attach_hetinput(income2)
household_inc3 = household3.attach_hetinput(income3)
...
def hank_ss(beta_guess=0.976, vphi_guess=2.07, chi1_guess=6.5, r=0.0125, delta=0.02, kappap=0.1,
    ...
    z1_grid, N_hh_occ11, N_hh_occ12, N_hh_occ13 = income1(e_grid, tax, w_occ1, w_occ2, w_occ3, gamma_hh1, m1, N1)
    z2_grid, N_hh_occ21, N_hh_occ22, N_hh_occ23 = income2(e_grid, tax, w_occ1, w_occ2, w_occ3, gamma_hh2, m2, N2)
    z3_grid, N_hh_occ31, N_hh_occ32, N_hh_occ33 = income3(e_grid, tax, w_occ1, w_occ2, w_occ3, gamma_hh3, m3, N3)
