...
def hank_ss(beta_guess=0.976, vphi_guess=2.07, chi1_guess=6.5, r=0.0125, delta=0.02, kappap=0.1,
            ...
            tot_wealth=14, Bh=1.04/10, Bg=2.8/10, G=0.2/10, noisy=True):
    ...
    w_occ1, w_occ2, w_occ3, N_sec1, N_sec2, N_sec3, m1, m2, m3 = test_wage_targeting_v2.out(sigma_sec1, sigma_sec2, sigma_sec3,
                                                                                            ...
                                                                                            N_hh_eff_1, N_hh_eff_2, N_hh_eff_3, p)
    ...
    alpha_sec_occ11 = (N_sec_occ11 * w_occ1) / (
            N_sec_occ11 * w_occ1 +
            N_sec_occ12 * w_occ2 +
            N_sec_occ13 * w_occ3)
    alpha_sec_occ12 = (N_sec_occ12 * w_occ2) / (
            N_sec_occ11 * w_occ1 +
            N_sec_occ12 * w_occ2 +
            N_sec_occ13 * w_occ3)
    alpha_sec_occ13 = (N_sec_occ13 * w_occ3) / (
            N_sec_occ11 * w_occ1 +
            N_sec_occ12 * w_occ2 +
            N_sec_occ13 * w_occ3)
    alpha_sec_occ21 = (N_sec_occ21 * w_occ1) / (
            N_sec_occ21 * w_occ1 +
            N_sec_occ22 * w_occ2 +
            N_sec_occ23 * w_occ3)
    alpha_sec_occ22 = (N_sec_occ22 * w_occ2) / (
            N_sec_occ21 * w_occ1 +
            N_sec_occ22 * w_occ2 +
            N_sec_occ23 * w_occ3)
    alpha_sec_occ23 = (N_sec_occ23 * w_occ3) / (
            N_sec_occ21 * w_occ1 +
            N_sec_occ22 * w_occ2 +
            N_sec_occ23 * w_occ3)
    alpha_sec_occ31 = (N_sec_occ31 * w_occ1) / (
            N_sec_occ31 * w_occ1 +
            N_sec_occ32 * w_occ2 +
            N_sec_occ33 * w_occ3)
    alpha_sec_occ32 = (N_sec_occ32 * w_occ2) / (
            N_sec_occ31 * w_occ1 +
            N_sec_occ32 * w_occ2 +
            N_sec_occ33 * w_occ3)
    alpha_sec_occ33 = (N_sec_occ33 * w_occ3) / (
            N_sec_occ31 * w_occ1 +
            N_sec_occ32 * w_occ2 +
            N_sec_occ33 * w_occ3)
    ...
    L_sec1 = (N_sec_occ11 ** alpha_sec_occ11 * N_sec_occ12 ** alpha_sec_occ12 * N_sec_occ13 ** alpha_sec_occ13)
    L_sec2 = (N_sec_occ21 ** alpha_sec_occ21 * N_sec_occ22 ** alpha_sec_occ22 * N_sec_occ23 ** alpha_sec_occ23)
    L_sec3 = (N_sec_occ31 ** alpha_sec_occ31 * N_sec_occ32 ** alpha_sec_occ32 * N_sec_occ33 ** alpha_sec_occ33)
