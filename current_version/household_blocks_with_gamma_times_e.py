...
def household1(Va1_p, Vb1_p, Pi_p, a1_grid, b1_grid, z_grid, e_grid, k_grid, beta, eis, rb, ra, chi0, chi1, chi2,
    ...
    u = [w_k * gamma_k * e_grid_k * uc_k for gamma_k, w_k, e_grid_k, uc_k in zip(gamma, w, e_grid, uc)]
...
def income_hh_1(q_1, q_2, q_3, e_grid, tax, w_occ_1, w_occ_2, w_occ_3, gamma_hh_1_1, gamma_hh_1_2, gamma_hh_1_3,
    ...
    z_grid_1 = [(1 - tax) * gamma_hh_1[0] * e_grid[k] * w_occ[0] * N_hh_1[0] * q_1 for k in range(len(e_grid))]
    z_grid_2 = [(1 - tax) * gamma_hh_1[1] * e_grid[k] * w_occ[1] * N_hh_1[1] * q_2 for k in range(len(e_grid))]
    z_grid_3 = [(1 - tax) * gamma_hh_1[2] * e_grid[k] * w_occ[2] * N_hh_1[2] * q_3 for k in range(len(e_grid))]
