...
import household_blocks_with_gamma_power_e
...
block_list = [consumers_aggregator, household_blocks_with_gamma_power_e.household_inc1, household_blocks_with_gamma_power_e.household_inc2,
              household_blocks_with_gamma_power_e.household_inc3, dividend, arbitrage, dividend_agg,
...
#                                rstar=ss['rstar']+drstar[:,0], use_saved=True)
